    ...
    return (
      <div className="card shadow-sm border-0">
        ...
        <div className="py-12 text-center border-2 border-dashed border-slate-200 rounded-xl">
          ...
          <p className="text-slate-600 text-sm font-bold">No campaigns found</p>
  ...
  return (
    <div className="card shadow-sm border-0">
      <div className="row-between mb-4">
        <h2 className="text-lg font-bold text-slate-800">Campaign Monitor</h2>
        <Link
          to="/ngo/campaigns"
          ...
          return (
            ...
            >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <Link
                        ...
                        className="font-bold text-slate-800 text-[15px] hover:text-primary"
                      >
                        {campaign.title}
                      </Link>
                      {isHighRisk && (
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                ...
                <div className="grid grid-cols-3 gap-2 text-center">
                  ...
                  <div>
                    ...
                    <div
                      className={`text-[13px] font-bold ${isHighRisk ? "text-red-600" : "text-slate-800"}`}
                    >
              ...
              {(campaign.pausedReason || campaign.closedReason) && (
                <div className="mt-2 p-2 bg-orange-50 border border-orange-200 rounded text-[11px] text-orange-700">
